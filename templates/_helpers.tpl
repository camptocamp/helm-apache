...
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}-mapserver
{{- end }}
...
{{- .Values.fullnameOverride | trunc 63 | trimSuffix "-" -}}-mapserver
{{- else -}}
{{- $name := default .Chart.Name .Values.nameOverride -}}
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}-mapserver
{{- else -}}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" -}}-mapserver
{{- end }}
{{- end }}
{{- end }}
...
app.kubernetes.io/component: mapserver
{{- end }}
